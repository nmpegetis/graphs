...
$spider_query = "select a1.FirstName, a1.LastName, a2.FirstName, a2.LastName, Similarity, EntityId1, EntityId2 from author as a1, author as a2, EntitySimilarity as es where a1.AuthorId=es.EntityId1 and a2.AuthorId=es.EntityId2 and Similarity>0.7 where ";
