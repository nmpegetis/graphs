...
//den ebala ta acr1
$query_graphLayout = "select EntityId1 as node1id,EntityId2 as node2id,Acr1 as node1name,Acr2 as node2name,Gr1_Category1 as category1_0,Gr1_Category2 as category1_2,Gr1_Category3 as category1_1,Gr2_Category1 as category2_0,Gr2_Category2 as category2_2,Gr2_Category3 as category2_1,grantsCnt1 as category1_counts,grantsCnt2 as category2_counts,Similarity from EntitySimilarityView where ExperimentId=?  and  Similarity>?";
...
$title = "OpenAIRE Review (March, 04 2015)";								// title of the webpage
$experimentName = "FETGrants_100T_1200IT_0IIT_150B_4M_cos";	// first experiment to load 
$experimentDescription = "Topic modeling analyzing: 1)218 ProjectAbstract, 585 PubAbstract, 2284 PubFullText, related to FP7 FET 2)Related Research Areas 3)Publication Venues (e.g., PubMed, Arxiv, ACM, Specific Journals) 4)Grants per Publication SimilarityType:cos"; 	// first description to load
$node_name = "Grant";
$node_groupName1 = "Projects";
$node_groupName2 = "Projects";
